...
Description:
    ...
    MatchedSet: each question's 3 alternatives are the exact same choice set the paired human
    respondent saw (see `data/messaging_app/raw answers/app_real.csv`).

Usage:
    export OPENAI_API_KEY=sk-...
    python3 llm_app_promptMatchedSet.py --limit 5      # smoke test
    python3 llm_app_promptMatchedSet.py
...
Output: `data/messaging_app/raw answers/sm_app_{model}_temp{temperature}_promptMatchedSet.csv`
"""
