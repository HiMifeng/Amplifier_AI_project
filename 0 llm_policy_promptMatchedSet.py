...
Description:
    ...
    respondent saw (see `data/energy_policy/raw answers/energypolicy_real.csv`).

Usage:
    export OPENAI_API_KEY=sk-...
    python3 llm_policy_promptMatchedSet.py --limit 5      # smoke test
    python3 llm_policy_promptMatchedSet.py
...
Output: `data/energy_policy/raw answers/sm_energypolicy_{model}_temp{temperature}_promptMatchedSet.csv`
"""
...
N_QUESTIONS = 14  # matches the original script
NONE_ALT = 4
MAX_API_RETRIES = 5
