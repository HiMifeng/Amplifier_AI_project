...
Usage:
    ...
    python3 llm_policy_promptBaseline.py --limit 5      # smoke test
    python3 llm_policy_promptBaseline.py

Input: demographics from `data/energy_policy/demographics/energypolicy_real.csv`; choice sets are randomly generated
Output: `data/energy_policy/raw answers/energypolicy_{model}_temp{temperature}.csv`
"""
...
def default_output_csv(model, temperature, dry_run=False):
    ...
    return study_dir / "raw answers" / f"energypolicy_{model_label}_temp{temperature:g}{suffix}"
