...
Description:
    ...
    No memory: unlike llm_policy_promptMatchedSet.py and llm_policy_promptBaseline.py, each
    of the 14 questions is asked in its OWN fresh conversation -- the persona and background are
...
Usage:
    ...
    python3 llm_policy_promptNoMemory.py --limit 5      # smoke test
    python3 llm_policy_promptNoMemory.py

Input: demographics from `data/energy_policy/demographics/energypolicy_real.csv`; choice sets are randomly generated
Output: `data/energy_policy/raw answers/sm_energypolicy_{model}_temp{temperature}_promptNoMemory.csv`
"""
